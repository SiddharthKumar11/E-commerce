                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400">sales@eshop.com</p>
                                </div>
                            </div>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex space-x-4">
                                <a href="#" className="bg-gray-100 dark:bg-gray-800 p-3 rounded-lg hover:bg-accent hover:text-white transition-colors">
